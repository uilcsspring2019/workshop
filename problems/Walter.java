...
public class Walter {
    ...
    public static boolean spc(double l, double w, double t) {
        if (l >= 3.5 && l <= 4.25 && w >= 3.5 && w <= 6 && t >= 0.007 && t <= 0.016)
            return true;
        else
            return false;
    }
    ...
    public static boolean lpc(double l, double w, double t) {
        if (l >= 4.25 && l <= 6 && w >= 6 && w <= 11.5 && t >= 0.007 && t <= 0.016)
            return true;
        else
            return false;
    }
    ...
    public static boolean se(double l, double w, double t) {
        if (l >= 3.5 && l <= 6.125 && w >= 5 && w <= 11.5 && t >= 0.016 && t <= 0.25)
            return true;
        else
            return false;
    }
    ...
    public static boolean le(double l, double w, double t) {
        if (l >= 6.125 && l <= 24 && w >= 11 && w <= 18 && t >= 0.25 && t <= 0.5)
            return true;
        else
            return false;
    }
    ...
    public static boolean sp(double l, double w, double t) {
        if (l > 24 && w > 18 && t > 0.5 && l + 2*w+2*t <= 84)
            return true;
        else
            return false;
    }
